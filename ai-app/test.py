...
def run_benchmark(concurrent_users=100, requests_per_user=10):
    ...
    for framework in ['flask', 'fastapi', 'django']:
        ...
        if framework == 'fastapi':
            ...
            # Add AI summarization endpoint test
            futures.append(loop.create_task(test_endpoint_async(framework, 'summarize', method='POST', 
                              payload={"text": "Lorem ipsum dolor sit amet " * 100})))
            ...
            summarization_response = test_endpoint_sync(framework, 'summarize', method='POST', payload={"text": "Lorem ipsum dolor sit amet " * 100})
            responses.append(summarization_response)
